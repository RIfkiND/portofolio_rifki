...
export function BlogBody({ searchTerm }: BlogBodyProps) {
  ...
  return (
    <>
      {/* Mobile Blog Body - Show on mobile screens only via CSS */}
      <div className="mobile-only">
        <MobileBlogBody posts={blogPosts} searchTerm={searchTerm} />
      </div>

      {/* Desktop Blog Body - Show on desktop screens only via CSS */}
