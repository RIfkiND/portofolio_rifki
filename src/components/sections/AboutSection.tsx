        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-gray-300 mb-6 leading-relaxed text-lg">
              I&apos;m a dedicated backend developer with over 1 year of hands-on experience in building 
              scalable web applications and APIs. Currently pursuing Software Engineering, I combine 
              academic knowledge with practical skills to create robust solutions.
            </p>
            <p className="text-gray-300 mb-8 leading-relaxed text-lg">
              My passion lies in crafting efficient backend systems, working with modern technologies, 
              and constantly learning new approaches to solve complex problems. I enjoy the challenge 
              of optimizing performance and ensuring system reliability.
            </p>
          ...
          <motion.div
            ...
            className="space-y-8"
          >
            <h4 className="text-xl font-bold text-white mb-6">Core Technologies</h4>
